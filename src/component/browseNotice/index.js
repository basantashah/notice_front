  ...
  constructor() {
    ...
    this.state = {
      ...
      data: [
      {
          ...
          "DeletedAt": null,
          "title": "title Ipsum has been the industry's standard dummy text ever since the",
          "expiry": "2018-09-22T11:27:31+05:45",
          "subject": "subject Ipsum has been the industry's standard dummy text ever since the",
    ...
    if(item.type=="application")
    {
      return(
        ...
        {item.title}
          ...
          <div class="rectangleSubject">
          {item.subject}
          </div>
          <div class="rectangleBody">
          {item.content}
          </div>
          <div class="rectangleDepart">
          {item.department}
          </div>
          </div>
        </div>
      ...
      <div>
        ...
        <div class="row" style={{ height: "10%" }}>
          {this.state.data &&
            this.state.data.map((item, index) => {
              if (item.urgent == true)
               return this.urgentFormatter(item)
            })}
        </div>
